export default function TermsOfService({ onBack }) {
  const sections = [
    { title: '1. Acceptance', body: 'By using TaskVerse Pi you agree to these Terms. If you do not agree, do not use the app.' },
    { title: '2. What TaskVerse Pi Does', body: 'TaskVerse Pi is a micro-task marketplace. Task posters escrow Pi to fund campaigns. Workers complete tasks and earn Pi. The platform charges a 5% fee on funded campaigns.' },
    ...
    { title: '6. Payments', body: 'All payments are processed in Pi cryptocurrency via the Pi Network SDK. TaskVerse Pi does not hold fiat currency. Payouts depend on Pi Network availability and may be delayed during maintenance.' },
    ...
    { title: '9. Limitation of Liability', body: 'TaskVerse Pi is provided as-is. We are not responsible for losses arising from Pi Network downtime, wallet issues, or third-party service failures.' },
