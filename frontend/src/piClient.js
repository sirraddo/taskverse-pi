...
export const submitProof = (taskId, payload) => api(`/api/tasks/${taskId}/submissions`, payload);
...
/** Worker appeal: submit a statement on the worker's own open dispute */
export const submitDisputeStatement = (disputeId, statement) =>
api(`/api/me/disputes/${disputeId}/statement`, { statement });
