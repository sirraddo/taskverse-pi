...
export default function MaintenancePage() {
  return (
    <div style={{
      maxWidth: '500px', margin: '0 auto', minHeight: '100vh', backgroundColor: '#f4f6fb',
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
      padding: '32px 24px', textAlign: 'center', fontFamily: 'sans-serif',
    }}>
      <div style={{ fontSize: '2.6rem', marginBottom: '14px' }}>🛠️</div>
      <h1 style={{ fontSize: '1.15rem', fontWeight: '800', color: '#1a202c', margin: '0 0 8px' }}>
        Down for quick maintenance
      </h1>
      <p style={{ fontSize: '0.88rem', color: '#718096', lineHeight: 1.6, maxWidth: '340px', margin: '0 0 4px' }}>
        TaskVerse Earn is briefly offline while we make some changes. Your balance and progress are safe — nothing is lost.
      </p>
      <p style={{ fontSize: '0.78rem', color: '#a0aec0', marginTop: '18px' }}>
